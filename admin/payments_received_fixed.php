...
if (isset($_GET['export'])) {
    ...
    if ($export_type === 'pending') {
        ...
        // En-têtes CSV
        fputcsv($output, ['ID Affilié', 'Affilié', 'Montant Total', 'Total Colis', 'Dernière Date', 'Statut']);
                            ...
                            <?php else: ?>
                                <?php foreach ($payments as $payment): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="store-logo me-2">CIH</div>
    ...
    <script>
        ...
        function settleAllPayments() {
            if (confirm('Êtes-vous sûr de vouloir régler tous les paiements en attente ?')) {
                ...
                .then(data => {
                    if (data.success) {
                        alert('Tous les paiements ont été réglés avec succès !');
                        location.reload();
                    } else {
